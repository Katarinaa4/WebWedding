...
{
    public class OrganizatorAzuriranjeMuzikeModel : PageModel
    {
        public WebWeddingContext _db { get; set; }

        [BindProperty]
        public Muzika novaMuzika { get; set; }
        ...
        public OrganizatorAzuriranjeMuzikeModel(WebWeddingContext db)
        {
            _db = db;
        }
        [BindProperty]
            ...
            if (parse)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        novaMuzika.Slika = fullPath;
                        novaMuzika.StatusPrikaza = "Prikaz";
                        await _db.Muzika.AddAsync(novaMuzika);
