...
{
    public class OrganizatorAzuriranjeDekoracijeModel : PageModel
    {
        ...
        [BindProperty]
        public Dekoracija novaDekoracija { get; set; }
        ...
        public OrganizatorAzuriranjeDekoracijeModel(WebWeddingContext db)
        {
            _db = db;
        }
            ...
            if (parse)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        novaDekoracija.Slika = fullPath;
                        novaDekoracija.StatusPrikaza = "Prikaz";
                        await _db.Dekoracije.AddAsync(novaDekoracija);
