...
namespace WebWedding.Migrations
{
    ...
    [Migration("20200502164041_Version2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebWedding.Models.Napomena", b =>
                {
                    b.HasOne("WebWedding.Dekoracija", null)
                        .WithMany("ListaNapomena")
                        .HasForeignKey("DekoracijaId");

                    b.HasOne("WebWedding.Fotograf", null)
                        .WithMany("ListaNapomena")
                        .HasForeignKey("FotografId");

                    b.HasOne("WebWedding.Muzika", null)
                        .WithMany("ListaNapomena")
                        .HasForeignKey("MuzikaId");

                    b.HasOne("WebWedding.Prostor", null)
                        .WithMany("ListaNapomena")
